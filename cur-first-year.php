	...
	$(window).bind('keydown', function(e){
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <p>Basic concepts of matter and its classification; mass relationships in chemical reactions; properties of gases, liquids and solids; concepts of thermos chemistry; quantum theory and electronic behavior; periodic relationship of elements in the periodic table, intermolecular forces; and solutions.
                <Br><Br>
                Prerequisite: None
                </p>
            </div><br><br><br><br><br><br><br>
            ...
            <div class="col-md-12">
                <p>Matrices and determinants, arithmetic and geometric series, solution sets of different types of inequalities and systems involving quadratics, solution of linear equations using determinants and matrices.
                <BR><br>
            ...
            <div class="col-md-12">
                <p>Equations of lines and conic sections; curve tracing in both rectangular and polar coordinates in two-dimensional space. 
                <Br><Br>
            ...
            <div class="col-md-12">
                <p>Concept of lines and planes; Cavalier’s and Volume theorems; formulas for areas of plane figures, volumes for solids; volumes and surface areas for spheres, pyramids, and cones; zone, sector and segment of a sphere; theorems of Pappus. 
                <br><bR>
                Prerequisite: College Algebra; Plane and Spherical Trigonometry
                </p>
            </div><br><br><br><br><br><br><br>            
