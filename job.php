    ...
    <div class="container"><br><br><br>
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content modal-md">
                                    <div class="modal-header blur" align="center">
                                        <h5 class="modal-title" id="hardwareEngineerLabel"> 
                                            HARDWARE ENGINEER
                                        </h5>
                        ...
                        <div class="modal fade" id="circuitDesign" tabindex="-1" role="dialog" aria-labelledby="circuitDesign" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body blur-body">
                                    <p align="justify">
                                        &emsp;&emsp;&emsp;
                                        Circuit design can cover systems ranging from complex electronic systems all the way down to the individual transistors within an integrated circuit. For simple circuits the design process can often be done by one person without needing a planned or structured design process, but for more complex designs, teams of designers following a systematic approach with intelligently guided computer simulation are becoming increasingly common. In integrated circuit design automation, the term "circuit design" often refers to the step of the design cycle which outputs the schematics of the integrated circuit.
                                    </p>
                                </div>
                                <div class="modal-footer blur">
                                    <button type="button" class="btn blur-button col-md-offset-5" data-dismiss="modal">OK</button>
                ...
                <!-- End of left job opportunities grid -->
                    ...
                    <div align="center">
                        ...
                        <div class="modal fade" id="softwareEngineer" tabindex="-1" role="dialog" aria-labelledby="softwareEngineer" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header blur">
                                        <h5 class="modal-title" id="softwareEngineerLabel"> 
                                            SOFTWARE ENGINEER
                                        </h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><strong>&times;</strong></span>
                    ...
                    <div class="col-md-6" align="center">
                        ...
                        <div class="modal fade" id="webDeveloper" tabindex="-1" role="dialog" aria-labelledby="webDeveloper" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header blur">
                                        <h5 class="modal-title" id="webDeveloper"> 
                                            WEB DEVELOPMENT
                                        </h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><strong>&times;</strong></span>
