	...
	$(window).bind('keydown', function(e){
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <p>This provides essential ideas, concepts, and principles in methods of research as well as the important skills needed by the researchers in the various techniques and procedures in the correct preparation and presentation of research report. Required output is a project proposal.
                <br><Br>
            ...
            <div class="col-md-12">
                <p>This is a course in which individuals or small teams use the principle of computer engineering in the design, building, and testing the special circuits or simple systems.
                <Br><Br>
            ...
            <div class="col-md-12">
                <p>It includes the journey into the world of entrepreneurship with introspection of business idea into a viable venture. The focus is on unleashing the entrepreneurship spirit in everyone.
                <Br><br>
            ...
            <div class="col-md-12">
                <p>Basic economy study methods; decisions under certainty; decisions recognizing risk; and decisions admitting uncertainty.
                <Br><br>
            ...
            <div class="col-md-12">
                <p>Includes seminars and lectures on current trends and issues on Computer Engineering developments. Includes field trips to different companies and plants dealing with computer system facilities.
                <Br><br>
                Prerequisite: None</p>
            </div><br><br><br><br><br><br><br>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <p>Includes computer networks and open system standards; transmission media and methods; LAN and WAN technologies; packet forwarding; host-to-host communications; network design; network administration, management and security.
                <Br><Br>
            ...
            <div class="col-md-12">
                <p>It includes moral issues and decisions confronting individuals and organizations involved in engineering. This subject will focus on the study of the code of ethics, conflict of interest, safety and risk tradeoffs in design, property, patents, trade secrets, and contemporary issues in engineering.
                <Br><Br>
                Prerequisite: At least 5th year standing</p>
            </div><br><br><br><br><br><br><br>
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <p>The subject includes lifecycle models for software development; software requirements specification; structured analysis and design; software metrics and planning; software testing; reusable management issues.
                <br><br>
